    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Welcome to My Blog</span></p>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        ...
                        <div class="card-body bg-light text-center p-4">
                            ...
                            <a href="<?= base_url('home/artikel/'.$uu['slug'])?>" class="btn btn-primary px-4 mx-auto my-2">Baca Lengkap</a>
                        </div>
                    </div>
                </div>
               <?php }?>
